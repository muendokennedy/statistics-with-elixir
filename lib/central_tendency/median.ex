defmodule Elixirstuts.CentralTendency.Median do
  ...
  def median(num_list) when is_list(num_list) do
    num_list |> Validators.validate_num_list() |> calc_median()
  end
  ...
  defp calc_median({true, num_list}) do
    ...
    num_list |> Enum.sort() |> get_median(Integer.is_even(count), count)
  end
